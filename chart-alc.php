...
<body class="vertical-layout">
            ...
            <div class="contentbar">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xl-4">
                        <div class="card m-b-30">
                            <div class="card-header">
                                <h5 class="card-title">Days Registered</h5>
                            </div>
                            <div class="card-body">  
                    ...
                    <div class="col-lg-12 col-xl-4">
                        <div class="card m-b-30">
                            <div class="card-header">
                                <h5 class="card-title">Days Present/Registered</h5>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="parents-slider-item">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-12 col-md-8">
                                                ...
                                                <p class="mb-0 font-14 font-italic">Title + First Name + Last Name, ALC 001</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="parents-slider-item">
   ...
   <!-- Start js -->        
    ...
    <script src="assets/js/custom/custom-chart-apex.js"></script>
     <!-- Slick js -->
    ...
    <script src="assets/js/custom/custom-chart-flot.js"></script>
    <!-- Core JS -->
